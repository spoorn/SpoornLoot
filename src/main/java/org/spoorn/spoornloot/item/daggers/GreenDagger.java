...
public class GreenDagger extends BaseDagger {

    public static final Identifier IDENTIFIER = new Identifier(MODID, "green_dagger");
    ...
    private static final int DEFAULT_ATK_DMG = 2;
    ...
    public GreenDagger(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
