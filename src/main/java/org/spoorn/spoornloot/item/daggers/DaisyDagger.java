...
public class DaisyDagger extends BaseDagger {

    public static final Identifier IDENTIFIER = new Identifier(MODID, "daisy_dagger");
    ...
    private static final int DEFAULT_ATK_DMG = 5;
    ...
    public DaisyDagger(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
