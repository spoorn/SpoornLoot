...
public class KikoDagger extends BaseDagger {

    public static final Identifier IDENTIFIER = new Identifier(MODID, "kiko_dagger");
    ...
    public KikoDagger(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
