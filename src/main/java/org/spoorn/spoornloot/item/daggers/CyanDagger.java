...
public class CyanDagger extends BaseDagger {

    public static final Identifier IDENTIFIER = new Identifier(MODID, "cyan_dagger");
    ...
    public CyanDagger(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
