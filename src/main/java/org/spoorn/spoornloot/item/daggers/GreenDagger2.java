...
public class GreenDagger2 extends BaseDagger {

    public static final Identifier IDENTIFIER = new Identifier(MODID, "green_dagger_2");
    ...
    private static final int DEFAULT_ATK_DMG = 3;
    ...
    public GreenDagger2(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
