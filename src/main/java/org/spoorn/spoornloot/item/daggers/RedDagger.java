...
public class RedDagger extends BaseDagger {
    ...
    public static final Identifier IDENTIFIER = new Identifier(MODID, "red_dagger");
    ...
    public RedDagger(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
