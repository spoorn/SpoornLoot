...
@Log4j2
public class PockyStrawberrySwordItem extends BaseLongSwordItem implements DualWieldable {

    public static final Identifier IDENTIFIER = new Identifier(MODID, "pocky_strawberry_sword");
    ...
    public PockyStrawberrySwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
